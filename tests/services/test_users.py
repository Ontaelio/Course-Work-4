...
class TestUsersService:
    ...
    def users_dao_mock(self, dao_mock, pass_hash):
        dao = dao_mock()
        dao.get_one.return_value = User(id=1, email='aaa@bbb.com', password='123456789')
        dao.get_all.return_value = [
            User(id=1, email='aaa@bbb.com', password='123456789'),
    ...
    @pytest.fixture
    def user(self, db):
        obj = User(email='aaa@bbb.com', password='pass')
        db.session.add(obj)
        db.session.commit()
        return obj
